...
import LoginForShowroom from './LoginForShowroom';
function Login() {
                    ...
                    <div>
                        <div className="col-md-12 login-sec">
                            <form><br />
                                ...
                                <button type="button" className="btn btn-primary btn-block" onClick={ShowroomLogin} >Showroom Login</button>
